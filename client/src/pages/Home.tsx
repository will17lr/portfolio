    ...
    <div className="min-h-screen bg-linear-to-b from-white via-slate-50 to-slate-100">
      ...
      <section className="relative overflow-hidden pt-36 pb-28">
        <div className="absolute inset-0 -z-10">
          <div className="absolute left-1/4 top-0 h-72 w-72 rounded-full bg-blue-100/40 blur-3xl"></div>
          <div className="absolute bottom-0 right-1/4 h-72 w-72 rounded-full bg-orange-100/30 blur-3xl"></div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-body text-gray-600 mb-8 max-w-lg leading-relaxed text-justify hyphens-auto">
                ...
                data et automatisation nourrit une approche rigoureuse des
                projets web.
              </p>
              ...
              <div className="relative overflow-hidden rounded-lg border border-gray-200 bg-gray-950 shadow-2xl">
                <div className="flex h-11 items-center justify-between border-b border-white/10 bg-[#1f2937] pl-4">
                  ...
                  <div className="flex h-full">
                    <span className="flex h-full w-11 items-center justify-center text-gray-300">
                      -
                    </span>
                    <span className="flex h-full w-11 items-center justify-center text-gray-300">
                      □
                    </span>
                    <span className="flex h-full w-11 items-center justify-center bg-red-600 text-white">
                      ×
                    </span>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
                    <div className="rounded-lg bg-blue-600 p-4 text-white shadow-lg">
                      <div className="mb-3 flex items-center justify-between">
                        ...
                        <span className="rounded-full bg-white/20 px-2 py-0.5 text-xs font-semibold animate-soft-pulse">
                          live
                        </span>
                      </div>
                    ...
                    <div className="rounded-lg border border-orange-300/30 bg-orange-400/10 p-4">
                      <p className="text-small font-semibold text-orange-200">
                        Objectif
                      </p>
                      <p className="mt-2 text-xs leading-5 text-white sm:text-sm sm:leading-6">
                        Relier intégration, logique métier et expérience
                        utilisateur.
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 px-4 pb-4 sm:px-5 sm:pb-5 2xl:grid-cols-4">
                  {[
                    ...
                    <div
                      key={label}
                      className="min-w-0 rounded-lg border border-white/10 bg-white/4 p-3"
                    >
                      <p className="text-xs font-semibold text-orange-200">
                        {label}
                      </p>
                      <p className="mt-1 overflow-wrap-anywhere text-xs leading-5 text-gray-300">
                        {detail}
                      </p>
                    </div>
                  ))}
      ...
      <section id="projects" className="py-20 container">
        ...
        <div className="space-y-28">
          ...
          <ProjectCard
            ...
            highlights={[
              "Carte dynamique matin/soir",
              "Réservations et messages clients",
              "Dashboard admin avec CRUD produits",
            ]}
            technologies={[
              "Node.js",
              "Express",
          ...
          <ProjectCard
            ...
            highlights={[
              "Affichage depuis données JSON",
              "Tri dynamique des véhicules",
              "Cartes générées côté client",
            ]}
            technologies={[
              "HTML5",
              "CSS3",
          ...
          <ProjectCard
            ...
            highlights={[
              ...
              "Interface responsive avec Vite",
            ]}
            technologies={[
              "React",
              "TypeScript",
      ...
      >
        <div className="container text-center" data-reveal>
          ...
          <p className="text-body text-blue-100 mb-8 max-w-2xl mx-auto">
            Je suis ouvert à de nouvelles opportunités et projets intéressants.
